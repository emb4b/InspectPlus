...
--
-- Email:    stephaniekimpineda@emb.gov.ph
-- Password: Test@1234

do $$
declare
  v_uid uuid := '01564488-522d-43b3-be0a-6d306071a0e7';
begin
  ...
  insert into auth.users (
    ...
    'stephaniekimpineda@emb.gov.ph', crypt('Test@1234', gen_salt('bf')),
    now(), now(), now(),
  ...
  insert into auth.identities (
    ...
    jsonb_build_object('sub', v_uid::text, 'email', 'stephaniekimpineda@emb.gov.ph'),
