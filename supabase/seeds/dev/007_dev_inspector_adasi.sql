...
--
-- Email:    adasi.emb4b@outlook.com
-- Password: Test@1234

do $$
declare
  v_uid uuid := '4061540d-daf1-49d7-aa1c-b20710224756';
begin
  ...
  insert into auth.users (
    ...
    'adasi.emb4b@outlook.com', crypt('Test@1234', gen_salt('bf')),
    now(), now(), now(),
  ...
  insert into auth.identities (
    ...
    jsonb_build_object('sub', v_uid::text, 'email', 'adasi.emb4b@outlook.com'),
  ...
  insert into public.user_accounts (
    ...
    v_uid::text, 'Abram Alexander', 'Delas Alas', 'Asi', 'adasi', 'Inspector',
    'Region 4B MIMAROPA', 'Oriental Mindoro', 'adasi.emb4b@outlook.com',
    true, 'synced', 'seed'
  )
