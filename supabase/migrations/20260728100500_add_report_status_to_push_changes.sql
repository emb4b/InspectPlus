...
-- Add report_status handling to push_changes for inspection_reports.
-- pull_changes needs no change — it uses to_jsonb(ir), which already
-- includes the new column automatically.
