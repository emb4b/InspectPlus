...
-- Update pull_changes / push_changes for the revised user_accounts /
-- establishments / purpose_of_inspection / inspection_reports columns and
-- for purpose_of_inspection's new independent (own updated_at) lifecycle.
-- user_accounts stays outside this RPC loop, same as before — it's read
-- and updated directly via PostgREST.
