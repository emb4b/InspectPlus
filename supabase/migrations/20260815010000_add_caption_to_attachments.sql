...
-- Optional inspector-entered caption per attachment. pull_changes needs no
-- change — it uses to_jsonb(a), which already includes the new column
-- automatically. push_changes is re-issued (full body, based on
-- 20260813011500_add_attachments_to_push_changes.sql, the last migration to
-- redefine it) with caption added to the attachments insert/update column
-- lists.
