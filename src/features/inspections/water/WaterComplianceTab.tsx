...
interface WaterComplianceTabProps {
...
export const WaterComplianceTab: React.FC<WaterComplianceTabProps> = ({ value, onChange }) => {
  // Every dynamic (add/remove-able) card/row below shares this pattern:
  // a single ref map keyed by a string built from the row index + field
  // name, since refs can't be created with useRef inside a .map(). `focus`
  // moves the keyboard to the next field on "next", or dismisses at the
  // end of a card/row (chaining stops at card boundaries — add/remove
  // would make cross-card indices unstable).
  ...
  return (
    <View>
      <FormSection icon="water-outline" title="Water Sources">
        <DynamicRowTable
          columns={[
      ...
      <FormSection icon="business-outline" title="Wastewater Sources">
        <DynamicRowTable
          columns={[
      ...
      <FormSection icon="flask-outline" title="Abstracted Water Quality">
        <DynamicRowTable
          columns={[
      ...
      <FormSection icon="cog-outline" title="Wastewater Treatment Plant (WWTP)">
      ...
      <FormSection icon="stats-chart-outline" title="Sampling Points">
      ...
      <FormSection icon="time-outline" title="Previous Inspection Summary">
        <View style={styles.row}>
          <DateField
      ...
      <FormSection icon="list-outline" title="Checklist — DAO 2005-10 (Water Quality)">
        <ChecklistTable
      ...
      <FormSection icon="document-text-outline" title="Discharge Permit Conditions">
